...
public class MoblNBLParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("MoblNBL");
  ...
  { 
    MoblNBLParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = MoblNBLParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = MoblNBLParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(MoblNBLParseControllerGenerated.class);
    }
  ...
  { 
    return MoblNBLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
